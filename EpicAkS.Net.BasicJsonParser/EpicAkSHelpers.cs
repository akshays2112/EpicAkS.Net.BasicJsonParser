...
{
    internal static class EpicAkSHelpers
    {
        ...
        internal static ClassHavingTypePropertyNameAliases[] GetAllClasses()
        {
            ...
            {
                if (!string.IsNullOrWhiteSpace(type.FullName) && (string.IsNullOrWhiteSpace(EpicAkSJsonHelpers.NamespaceScoped) || 
                    (!string.IsNullOrWhiteSpace(EpicAkSJsonHelpers.NamespaceScoped) && type.FullName.StartsWith(EpicAkSJsonHelpers.NamespaceScoped))))
                {
